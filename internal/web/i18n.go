...
var translations = map[string]map[string]string{
	"en": {
		...
		"register_not_invited":               "This email address has not been invited. Please contact an administrator.",
	...
	"nl": {
		...
		"register_not_invited":               "Dit e-mailadres is niet uitgenodigd. Neem contact op met een beheerder.",
